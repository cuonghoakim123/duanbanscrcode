...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($name)) {
        ...
        // Kiểm tra slug và SKU đã tồn tại chưa (trừ sản phẩm hiện tại)
        $check_query = "SELECT id FROM products WHERE (slug = :slug OR sku = :sku) AND id != :id";
...
<div class="admin-card">
    <div class="admin-card-header">
        <h5><i class="fas fa-edit"></i> Sửa sản phẩm: <?php echo htmlspecialchars($product['name']); ?></h5>
        <div class="d-flex gap-2">
            <a href="products.php?view=<?php echo $product_id; ?>" class="btn-admin btn-admin-sm" style="background: #4299e1; color: white;">
                        ...
                        <div class="admin-card-body">
                            ...
                            <div class="form-group-admin mb-3">
                                ...
                                <textarea name="description" class="form-control-admin" rows="3" 
                                          placeholder="Mô tả ngắn về sản phẩm"><?php echo htmlspecialchars($product['description'] ?? ''); ?></textarea>
                            </div>
                            
                            <div class="form-group-admin mb-3">
                                <label class="form-label-admin">Nội dung chi tiết</label>
                                <textarea name="content" class="form-control-admin" rows="6" 
                                          placeholder="Nội dung mô tả chi tiết sản phẩm"><?php echo htmlspecialchars($product['content'] ?? ''); ?></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="admin-card mb-4">
                        ...
                        <div class="admin-card-body">
                            <div class="form-group-admin mb-3">
                                ...
                                <div id="imagePreview" class="mt-3" <?php echo $product['image'] ? '' : 'style="display: none;"'; ?>>
                                    <div class="position-relative d-inline-block">
                                        <img id="previewImg" src="<?php echo $product['image'] ? htmlspecialchars($product['image']) : ''; ?>" alt="Preview" 
                            ...
                            <div class="form-group-admin">
                                ...
                                <textarea name="gallery" id="galleryUrls" class="form-control-admin" rows="3" 
                                          placeholder="URLs hình ảnh, cách nhau bởi dấu phẩy hoặc upload nhiều ảnh"><?php echo htmlspecialchars($product['gallery'] ?? ''); ?></textarea>
                                <div id="galleryPreview" class="mt-3 d-flex flex-wrap gap-2">
                                    <?php if($product['gallery']): 
                                        $gallery_images = array_filter(array_map('trim', explode(',', $product['gallery'])));
                                        foreach($gallery_images as $gallery_img): ?>
                                            <div style="position: relative; width: 100px; height: 100px;">
                                                <img src="<?php echo htmlspecialchars($gallery_img); ?>" alt="Gallery" 
                                                ...
                                                <button type="button" class="btn btn-sm btn-danger" 
                                                        ...
                                                        onclick="removeGalleryImage(this, '<?php echo htmlspecialchars($gallery_img); ?>')">
                ...
                <div class="col-md-4">
                    ...
                    <div class="admin-card mb-4">
                        ...
                        <div class="admin-card-body">
                            ...
                            <div class="form-group-admin">
                                <label class="form-label-admin">Lượt xem</label>
                                <input type="text" class="form-control-admin" 
                                       value="<?php echo number_format($product['views']); ?>" 
